...
function cwvpsb_whitelist_css_code($css){
	...
	if (function_exists('premitheme_widgets_notice')) {
 	...
 	if ( function_exists( 'zeen_logo' ) ) {
		$css = '.block.block-79.tipi-flex.preview-review-bot article.tipi-xs-12 {height: 65%;}.block-ani.loaded article {animation-timing-function: cubic-bezier(0,0,0.3,1);animation-fill-mode: forwards;animation-duration: .2s;animation-name: tipiSlideUpOpa;animation-delay: calc(0.075s * var(--animation-order));}.modal-wrap.active {visibility: visible;opacity: 1;}.timed-pup, .modal-wrap {position: fixed;visibility: hidden;}.timed-pup, .modal-wrap {z-index: 110;opacity: 0;transition: .2s all;}.modal-wrap.active-3 .tipi-overlay {opacity: .975;}.modal-wrap.active-3 .content-search {opacity: 1;visibility: visible;}.modal-wrap.active{visibility:visible;opacity:1}.modal-wrap.active .tipi-x-outer{opacity:1}.modal-wrap.active .close i{opacity:1}.modal-wrap.active-3 .tipi-overlay{opacity:.975}.modal-wrap.active-3 .dark-overlay .tipi-overlay{opacity:.925}.modal-wrap.active-3 .search{transition-delay:.3s;transform:translate3d(0,0,0);opacity:1;visibility:visible}.modal-wrap.active-3 .search-hints{transition-delay:.4s;transform:translate3d(0,0,0);opacity:.5;visibility:visible}.modal-wrap.active-3 .content-search{opacity:1;visibility:visible}.lwa-active-3 .tipi-lwa-register,.lwa-active-3 .tipi-lwa-login{display:none}.active-3 .close i{color:#000}.tipi-tile.active .content>div{opacity:1;transform:translatex(0);transition:opacity .3s ease-out .25s,transform .3s cubic-bezier(0,0,0.3,1) .25s}.tipi-tile.active .content>div:nth-child(2){transition-delay:.25s}.tipi-tile.active .content>div:nth-child(3){transition-delay:.35s}.tipi-tile.active .content>div:nth-child(4){transition-delay:.45s}.tipi-tile.active .content>div:nth-child(5){transition-delay:.55s}.tipi-tile.active .content>div:nth-child(6){transition-delay:.65s}.tipi-tile.active .content>div:nth-child(7){transition-delay:.75s}.tipi-tile.active .content>div:nth-child(8){transition-delay:.85s}.modal-wrap:not(.active) iframe,.slide-in-menu:not(.active) .wpforms-container-full,.slide-in-menu:not(.active) .wpforms-container-full *,.slide-in-menu:not(.active) iframe{visibility:hidden !important}.tipi-tile-cart.active, .tipi-tile.active {transition: opacity .3s ease-out,transform .3s cubic-bezier(0,0,0.3,1),visibility 0s;opacity: 1;visibility: visible;transform: translateX(0);}li.menu-item.active {background: #212121;color: #fff;}';
	}
  	return $css;
}